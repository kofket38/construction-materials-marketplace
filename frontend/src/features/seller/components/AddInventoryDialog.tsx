        ...
        <form className="mt-6 space-y-5" onSubmit={handleSubmit} noValidate>
          ...
          <div>
            ...
            {productsQuery.isPending ? (
              ...
              <select
                className="mt-2 min-h-11 w-full rounded-md border border-zinc-300 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-700 focus:ring-2 focus:ring-emerald-700/15 disabled:opacity-60"
                disabled={isPending}
                id="inv-product"
