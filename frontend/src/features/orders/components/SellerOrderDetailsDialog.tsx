...
export function SellerOrderDetailsDialog({
  ...
  return (
    <>
      <div
        className="fixed inset-0 z-40 flex items-end justify-center bg-scrim/50 p-0 sm:items-center sm:p-6"
        onMouseDown={(event) => {
          if (
      ...
      >
        <section
          ...
          aria-modal="true"
          className="flex max-h-[100dvh] w-full flex-col overflow-hidden rounded-t-md bg-canvas shadow-2xl sm:max-h-[calc(100dvh-3rem)] sm:max-w-5xl sm:rounded-md"
          role="dialog"
        >
            ...
            <footer className="shrink-0 border-t border-zinc-200 bg-white px-4 py-4 sm:px-6">
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex flex-col-reverse gap-2 sm:ml-auto sm:flex-row">
                  ...
                  {primaryAction ? (
                    <button
                      className="inline-flex min-h-11 items-center justify-center gap-2 rounded-md bg-brand px-4 py-2 text-sm font-semibold text-on-brand hover:bg-brand-hover disabled:cursor-not-allowed disabled:opacity-60"
                      disabled={isMutating}
                      onClick={() =>
  ...
  return (
    <div className="grid gap-4 sm:grid-cols-[minmax(0,1fr)_12rem]">
      <div>
        ...
        {proofObjectUrl ? (
          <a
            className="mt-4 inline-flex items-center gap-2 text-sm font-semibold text-brand-ink hover:text-brand-ink"
...
function PaymentActions({
  ...
  return (
    <div className="flex flex-col gap-2 sm:flex-row">
      ...
      <button
        className="inline-flex min-h-11 items-center justify-center gap-2 rounded-md bg-brand px-4 py-2 text-sm font-semibold text-on-brand hover:bg-brand-hover disabled:opacity-50"
        disabled={isPending}
